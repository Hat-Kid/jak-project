  ...
  if (original_dest == s7.offset + FIX_SYM_TRUE) {
    ...
    *PrintPendingLocal3 = 0;
    ...
    if ((original_dest & OFFSET_MASK) == BASIC_OFFSET) {
      Ptr<jak3::Type> type = *Ptr<Ptr<jak3::Type>>(original_dest - 4);
      if (type == *Ptr<Ptr<jak3::Type>>(s7.offset + FIX_SYM_STRING_TYPE - 1)) {
        ...
        *PrintPendingLocal3 = 0;
        return 0;
      } else if (type == *Ptr<Ptr<jak3::Type>>(s7.offset + FIX_SYM_FILE_STREAM - 1)) {
